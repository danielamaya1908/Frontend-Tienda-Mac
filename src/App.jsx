...
import TechnicalSupport from './components/TechnicalSupport/TechnicalSupport'; // Importa el componente TechnicalSupport
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/technical-support" element={<TechnicalSupport />} /> {/* Ruta para el componente TechnicalSupport */}
