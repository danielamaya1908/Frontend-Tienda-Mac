...
const Condition = () => {
  ...
  useEffect(() => {
    const fetchConditions = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/condition');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.editingConditionId) {
        ...
        await axios.put(`https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/condition/${formData.editingConditionId}`, formData);
        ...
        const { name } = formData;
        const response = await axios.post('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/condition', { name });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/condition/${id}`);
