...
const Categories = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = formData.editingCategoryId
      ? `https://backend-tienda-mac-production.up.railway.appupdateCategory/${formData.editingCategoryId}`
      : 'https://backend-tienda-mac-production.up.railway.appcreateCategory';
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://backend-tienda-mac-production.up.railway.appdeleteCategory/${id}`);
