...
import { faUsers, faShoppingBasket, faTicketAlt, faTrademark, faListAlt, faPalette, faCubes, faCheckSquare, faShoppingCart, faTools } from '@fortawesome/free-solid-svg-icons'; // Asegúrate de importar el ícono adecuado
