...
const Subcategories = () => {
    ...
    useEffect(() => {
        const fetchSubcategories = async () => {
            try {
                const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/getAllSubcategories');
    ...
    const handleSubmit = async (e) => {
        ...
        const url = formData.editingSubcategoryId ? `https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/updateSubcategories/${formData.editingSubcategoryId}` : 'https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/createSubcategories';
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/deleteSubcategories/${id}`);
