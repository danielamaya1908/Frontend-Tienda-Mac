...
const Subcategories = () => {
    ...
    useEffect(() => {
        const fetchSubcategories = async () => {
            try {
                const response = await axios.get('https://backend-tienda-mac-production.up.railway.appgetAllSubcategories');
    ...
    const handleSubmit = async (e) => {
        ...
        const url = formData.editingSubcategoryId ? `https://backend-tienda-mac-production.up.railway.appupdateSubcategories/${formData.editingSubcategoryId}` : 'https://backend-tienda-mac-production.up.railway.appcreateSubcategories';
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://backend-tienda-mac-production.up.railway.appdeleteSubcategories/${id}`);
