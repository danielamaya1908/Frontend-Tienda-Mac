...
const Capacity = () => {
    ...
    useEffect(() => {
        const fetchCapacities = async () => {
            try {
                const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/getAllCapacities');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (formData.editingCapacityId) {
                await axios.put(`https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/updateCapacities/${formData.editingCapacityId}`, formData);
                setCapacities(capacities.map(cap => (cap.id === formData.editingCapacityId ? formData : cap)));
                alert('Capacidad actualizada con éxito');
            } else {
                const response = await axios.post('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/createCapacities', formData);
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/deleteCapacities/${id}`);
