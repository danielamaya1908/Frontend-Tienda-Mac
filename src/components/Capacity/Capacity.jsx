...
const Capacity = () => {
    ...
    useEffect(() => {
        const fetchCapacities = async () => {
            try {
                const response = await axios.get('https://backend-tienda-mac-production.up.railway.appgetAllCapacities');
        ...
        const fetchCategories = async () => {
            try {
                const response = await axios.get('https://backend-tienda-mac-production.up.railway.appgetAllCategories');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (formData.editingCapacityId) {
                await axios.put(`https://backend-tienda-mac-production.up.railway.appupdateCapacities/${formData.editingCapacityId}`, formData);
                setCapacities(capacities.map(cap => (cap.id === formData.editingCapacityId ? formData : cap)));
                alert('Capacidad actualizada con éxito');
            } else {
                const response = await axios.post('https://backend-tienda-mac-production.up.railway.appcreateCapacities', formData);
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://backend-tienda-mac-production.up.railway.appdeleteCapacities/${id}`);
