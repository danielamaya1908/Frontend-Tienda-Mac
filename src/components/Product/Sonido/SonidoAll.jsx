    ...
    const fetchsonidoProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Accesorios%20de%20audio/subcategory/Parlantes'),
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Accesorios%20de%20audio/subcategory/Auriculares%20intraaurales%20de%20cable'),
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Accesorios%20de%20audio/subcategory/Bocinas%20portátil'),
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Accesorios%20de%20audio/subcategory/Audífonos%20diademas'),
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Parlantes/subcategory/Parlante%20Portátil')
        ]);
  ...
  return (
    <div className="sonido-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4">Todo de Sonido</h1>
