    ...
    const fetchAirpodsProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Smartwatches%20y%20accesorios/subcategory/Smartwatches/name/Apple%20Watch%20SE%202.ª%20generación'),
          axios.get('https://backend-tienda-mac-production.up.railway.appproduct/632'),
          axios.get('https://backend-tienda-mac-production.up.railway.appproduct/633'),
        ]);                                                                                          
