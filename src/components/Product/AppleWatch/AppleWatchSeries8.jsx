...
const AppleWatchSeries8 = () => {
  ...
  useEffect(() => {
    const fetchAppleWatchProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Smartwatches%20y%20accesorios/subcategory/Smartwatches/name/Apple%20Watch%20Series%208');
  ...
  return (
    <div className="AppleWatch-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4">Apple Watch Series 8</h1>
