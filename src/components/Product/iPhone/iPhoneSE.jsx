...
const IphoneSE = () => {
  ...
  useEffect(() => {
    const fetchIphoneProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Smartphones/subcategory/iPhone/name/iPhone%20SE%20(3.ª generación)');
