    ...
    const fetchIphoneProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Smartphones/subcategory/iPhone/name/iPhone%2015'),
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Smartphones/subcategory/iPhone/name/iPhone%2015%20Plus')
        ]);
  ...
  return (
    <div className="iphone-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4">iPhone 15</h1>
