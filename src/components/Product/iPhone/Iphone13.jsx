    ...
    const fetchIphoneProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Smartphones/subcategory/iPhone/name/iPhone%2013'),
         /*  axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Smartphones/subcategory/iPhone/name/iPhone%2013%20Mini') */
        ]);
