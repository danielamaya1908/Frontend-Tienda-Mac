...
const ProductForm = ({ onSubmit }) => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch('https://backend-tienda-mac-production.up.railway.appgetAllCategories');
      if (!response.ok) {
  ...
  const fetchBrands = async () => {
    try {
      const response = await fetch('https://backend-tienda-mac-production.up.railway.appgetAllBrands');
      if (!response.ok) {
  ...
  const fetchCapacities = async () => {
    try {
      const response = await fetch('https://backend-tienda-mac-production.up.railway.appgetAllCapacities');
      if (!response.ok) {
  ...
  const fetchSubcategories = async () => {
    try {
      const response = await fetch('https://backend-tienda-mac-production.up.railway.appgetAllSubcategories');
      if (!response.ok) {
  ...
  const fetchConditions = async () => {
    try {
      const response = await fetch('https://backend-tienda-mac-production.up.railway.appcondition'); // Endpoint para obtener condiciones
      if (!response.ok) {
  ...
  const fetchColors = async () => {
    try {
      const response = await fetch('https://backend-tienda-mac-production.up.railway.appproduct/colors');
      if (!response.ok) {
