...
const ProductForm = ({ onSubmit }) => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch('${BACKEND_URL}/getAllCategories');
      if (!response.ok) {
  ...
  const fetchBrands = async () => {
    try {
      const response = await fetch('${BACKEND_URL}/getAllBrands');
      if (!response.ok) {
  ...
  const fetchCapacities = async () => {
    try {
      const response = await fetch('${BACKEND_URL}/getAllCapacities');
      if (!response.ok) {
  ...
  const fetchSubcategories = async () => {
    try {
      const response = await fetch('${BACKEND_URL}/getAllSubcategories');
      if (!response.ok) {
