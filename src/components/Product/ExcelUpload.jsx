...
const ExcelUpload = () => {
  ...
  const handleSubmitProducts = async (e) => {
    ...
    if (fileProducts) {
      ...
      try {
        const response = await axios.post('https://backend-tienda-mac-production.up.railway.apppostExcelProducts', formData, {
          headers: {
  ...
  const handleSubmitImages = async (e) => {
    ...
    if (fileImages) {
      ...
      try {
        const response = await axios.post('https://backend-tienda-mac-production.up.railway.apppostExcelImages', formData, {
          headers: {
            'Content-Type': 'multipart/form-data'
          }
        });
