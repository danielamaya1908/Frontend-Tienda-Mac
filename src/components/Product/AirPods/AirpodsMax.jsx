    ...
    const fetchAirpodsProducts = async () => {
      try {
        const responses = await Promise.all([
            axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Audifonos/subcategory/Auriculares/name/AirPods%20Max')
        ]);                                                                                          
  ...
  return (
    <div className="Airpods-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4">Airpods Max</h1>
