    ...
    const fetchMacProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Computación/subcategory/MacBook/name/MacBook%20Air%20de%2013%20pulgadas'),
          axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Computación/subcategory/MacBook/name/MacBook%20Air%20de%2015%20pulgadas')
        ]);
