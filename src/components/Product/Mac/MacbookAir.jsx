    ...
    const fetchMacProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Computación/subcategory/MacBook/name/MacBook%20Air%20de%2013%20pulgadas'),
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Computación/subcategory/MacBook/name/MacBook%20Air%20de%2015%20pulgadas')
        ]);
  ...
  return (
    <div className="Mac-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4">Macbook Air</h1>
