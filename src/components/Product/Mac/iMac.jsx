...
const iMac = () => {
  ...
  useEffect(() => {
    const fetchMacProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Computación/subcategory/iMac');
  ...
  return (
    <div className="Mac-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4 fs-4">Productos Mac</h1>
