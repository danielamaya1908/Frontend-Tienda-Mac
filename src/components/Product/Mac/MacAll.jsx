    ...
    const fetchMacProducts = async () => {
      try {
        const responses = await Promise.all([
            axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Computación/subcategory/MacBook'),
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Computación/subcategory/Mac%20studio'),
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Computación/subcategory/Mac%20mini'),
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Computación/subcategory/iMac')
        ]);
  ...
  return (
    <div className="Mac-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4">MacbookPro Pro</h1>
