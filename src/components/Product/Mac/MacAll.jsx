    ...
    const fetchMacProducts = async () => {
      try {
        const responses = await Promise.all([
            axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Computación/subcategory/MacBook'),
          axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Computación/subcategory/Mac%20studio'),
          axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Computación/subcategory/Mac%20mini'),
          axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Computación/subcategory/iMac')
        ]);
