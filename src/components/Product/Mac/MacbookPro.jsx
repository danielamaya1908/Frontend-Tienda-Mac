    ...
    const fetchMacProducts = async () => {
      try {
        const responses = await Promise.all([
            axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Computación/subcategory/MacBook/name/MacBook%20Pro%20de%2013%20pulgadas'),
          axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Computación/subcategory/MacBook/name/MacBook%20Pro%20de%2014%20pulgadas'),
          axios.get('https://backend-tienda-mac-production.up.railway.appproducts/category/Computación/subcategory/MacBook/name/MacBook%20Pro%20de%2016%20pulgadas')
        ]);
