...
const DetalleProducto = () => {
  ...
  useEffect(() => {
    const fetchProductDetails = async () => {
      ...
      setError(null);
      try {
        const productResponse = await axios.get(`https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/product/${id}`);
        setProduct(productResponse.data);

        const imageResponse = await axios.get(`https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/${id}/images`);
