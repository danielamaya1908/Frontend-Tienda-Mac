    ...
    const fetchIpadProducts = async () => {
      try {
        const responses = await Promise.all([
          axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Computación/subcategory/Tablets/name/iPad%20Pro'),
        ]);
  ...
  return (
    <div className="ipad-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4">iPad Pro</h1>
