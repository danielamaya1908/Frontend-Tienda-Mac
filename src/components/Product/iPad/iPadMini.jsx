...
const iPadmini = () => {
  ...
  useEffect(() => {
    const fetchIpadProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Computación/subcategory/Tablets/name/iPad%20mini%20Wi-Fi-%206.ª%20generación');
  ...
  return (
    <div className="ipad-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4">iPad Mini</h1>
