...
const IpadUsed = () => {
  ...
  useEffect(() => {
    const fetchIpadProducts = async () => {
      try {
        const response = await axios.get('https://backend-tienda-mac-production.up.railway.app/products/category/Accesorios%20de%20video/products/category/Smartphones/subcategory/Ipad/name/Ipad%20SE%20(3.ª generación)');
  ...
  return (
    <div className="Ipad-products">
      ...
      <div className="container py-5">
        <h1 className="text-center mb-4">iPad Usados</h1>
