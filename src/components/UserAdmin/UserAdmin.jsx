...
const UserAdminManagement = () => {
  ...
  useEffect(() => {
    const getUsers = async () => {
      try {
        const response = await axios.get('{process.env.BACKEND_URL}/getAllUserAdmins');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isUpdateMode) {
        await axios.put(`{process.env.BACKEND_URL}/updateUserAdmin/${formData.id}`, formData);
        ...
        const response = await axios.post('{process.env.BACKEND_URL}/userAdmin', formData);
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`{process.env.BACKEND_URL}/deleteUserAdmin/${id}`);
